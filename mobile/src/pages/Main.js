...
function Main({navigation}){
  ...
  return (
    ...
    <View style={styles.searchForm}>
      <TextInput value={techs} onChangeText={setTechs} style={styles.searchInput} placeholder="Buscar devs por Techs" placeholderTextColor="#999"
      autoCapitalize="words" autoCorrect={false}></TextInput>
